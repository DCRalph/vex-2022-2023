...
// bool cataLastMoving = false;
// int cataResetState = 0;
...
//   else
//   {
//     if (cataLastMoving == true)
//       cataMoving = false;

//     if (cataResetState == 1)
//     {

//       if (cata.power(watt) > 3)
//       {
//         cataResetState = 2;

//         cata.resetPosition();
//         cata.spinFor(900, rotationUnits::deg, true);
//       }
//     }
//   }
...
//         cata.spinFor(200, rotationUnits::deg, true);
//       }
//       else
//       {
//         cataResetState = 1;

//         cata.spin(directionType::fwd, 50, velocityUnits::pct);
//       }
...
void calabrate(void)
{
  ...
  cata.spinFor(900, rotationUnits::deg, 50, velocityUnits::pct, true);
  ...
  // while (cata.power(watt) < 3 || cata.position(deg) < 1200)
  //   ;
  // cataROT = cata.position(deg);
  ...
  // cata.spinFor(1800 * 5, rotationUnits::deg, true);
}
...
void user(void)
{
  ...
  while (1)
  {
    ...
    {
      intake.spin(directionType::fwd, 14, voltageUnits::volt);
    }
    else if (Controller1.ButtonL2.pressing())
    {
      intake.spin(directionType::rev, 14, voltageUnits::volt);
    }
    else
    {
      intake.stop();
